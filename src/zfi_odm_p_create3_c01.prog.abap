    ...
    CASE sy-ucomm.
      ...
      WHEN '&SAVE'.
        IF p_laufi IS NOT INITIAL
          ...
          lcl_main=>main_save( ).
        ELSE.
          MESSAGE 'Tanıtıcı ve Açıklama Alanı Boş Olamaz' TYPE 'S' DISPLAY LIKE 'E'.
        ENDIF.
    ENDCASE.
...
*&---------------------------------------------------------------------*
  METHOD get_data .
    ...
    ELSE.
      ...
      MESSAGE 'Kullanıcı Adına Uygun Kategori Bulunamadı.' TYPE 'S' DISPLAY LIKE 'E'.
        ...
        WHEN gc_alvname-list.
          CASE ls_fcat-fieldname.
            ...
            WHEN 'ODNCKTU'.
              ...
              ls_fcat-reptext =
              ls_fcat-coltext =
              ls_fcat-seltext = 'Ödenecek Tutar'.
            WHEN 'ODTUTAR'.
              ls_fcat-no_out = 'X'.
            WHEN 'GECVADE'.
              ls_fcat-scrtext_s =
              ...
              ls_fcat-reptext =
              ls_fcat-coltext =
              ls_fcat-seltext = 'Vadesi Geçenler'.
            WHEN 'GELVADE'.
              ls_fcat-scrtext_s =
              ls_fcat-scrtext_m =
              ls_fcat-scrtext_l =
              ls_fcat-reptext =
              ls_fcat-coltext =
              ls_fcat-seltext = 'Vadesi Geçmeyenler'.
          ENDCASE.
...
*     MODIFY zfi_odm_t_001 FROM TABLE gt_zfiodmt001.
    ...
    IF gt_zfiodmt003 IS NOT INITIAL.
      ...
      IF gt_zfiodmt004 IS NOT INITIAL.
        ...
        MESSAGE 'Ödeme Önerisi Oluşturuldu' TYPE 'S'.
      ENDIF.
...
* Implement suitable error handling here
      ...
      ELSEIF gs_alv-odncktu = 0.
        MESSAGE 'Ödeme Önerisi Tutarı 0 olamaz' TYPE 'S' DISPLAY LIKE 'E'.
      ELSE.
