...
*&---------------------------------------------------------------------*
  METHOD screen_pai .
    ...
    IF iv_exit EQ 'X'.
      CASE iv_ucomm.
        WHEN 'BACK' OR 'UP' OR 'CANC' OR '&BACK'.
          LEAVE TO SCREEN 0.
        WHEN 'EXIT'.
          LEAVE PROGRAM.
        WHEN OTHERS.
...
*      SET HANDLER go_handler->handle_double_click FOR go_grid_0100.
      ...
      SET HANDLER go_handler->handle_data_changed FOR go_grid_0100.
      SET HANDLER go_handler->handle_data_finished FOR go_grid_0100.
